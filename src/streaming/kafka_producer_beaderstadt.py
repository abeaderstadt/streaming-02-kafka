"""src/streaming/kafka_producer_beaderstadt.py - Kafka customized producer.
...
def transform_superstore_row(row: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "is_online": ship_mode in ["Standard Class", "Second Class"],
        "customer_id": row["Customer ID"],
        "is_new_customer": random.choice([True, False]),
        # synthetic fields (needed to match the schema)
        "device_type": "desktop",
        "payment_method": "card",
